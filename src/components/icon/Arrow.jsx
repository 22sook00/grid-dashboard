...
export const ArrowNavUpIcon = ({ width = 24, height = 24, color = 'currentColor', ...props }) => {
  // *둥글둥글 화살표임
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M15.5333 14.0609C15.7933 13.8009 15.7933 13.3809 15.5333 13.1209L12.4733 10.0609C12.2133 9.80086 11.7933 9.80086 11.5333 10.0609L8.47327 13.1209C8.21327 13.3809 8.21327 13.8009 8.47327 14.0609C8.73327 14.3209 9.15327 14.3209 9.41327 14.0609L12.0066 11.4742L14.5933 14.0609C14.8533 14.3142 15.2799 14.3142 15.5333 14.0609Z"
        fill={color}
      />
    </svg>
  )
...
export const ArrowNavDownIcon = ({ width = 24, height = 24, color = 'currentColor', ...props }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M8.46673 9.93914C8.20673 10.1991 8.20673 10.6191 8.46673 10.8791L11.5267 13.9391C11.7867 14.1991 12.2067 14.1991 12.4667 13.9391L15.5267 10.8791C15.7867 10.6191 15.7867 10.1991 15.5267 9.93914C15.2667 9.67914 14.8467 9.67914 14.5867 9.93914L11.9934 12.5258L9.40673 9.93914C9.14673 9.6858 8.72006 9.6858 8.46673 9.93914Z"
        fill={color}
      />
    </svg>
  )
